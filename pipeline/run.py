...
def _pitcher_publication_fields(record: dict) -> dict:
    """Return the pitcher assignment and provenance fields that must travel together."""
    return {
        "home_pitcher": record.get("home_pitcher"),
        "home_pitcher_hand": record.get("home_pitcher_hand"),
        "home_pitcher_source": record.get("home_pitcher_source"),
        "home_pitcher_last_checked": record.get("home_pitcher_last_checked"),
        "home_pitcher_cache_stale": bool(record.get("home_pitcher_cache_stale", False)),
        "away_pitcher": record.get("away_pitcher"),
        "away_pitcher_hand": record.get("away_pitcher_hand"),
        "away_pitcher_source": record.get("away_pitcher_source"),
        "away_pitcher_last_checked": record.get("away_pitcher_last_checked"),
        "away_pitcher_cache_stale": bool(record.get("away_pitcher_cache_stale", False)),
        "pitcher_warnings": list(record.get("pitcher_warnings") or []),
    }
    ...
    for rec in prediction_records:
        ...
        for outcome in outcomes:
            ...
            formatted_pick = {
                ...
                **_pitcher_publication_fields(rec),
                "pick": outcome,
...
def run_sport_pipeline(sport_key, output_dir=None, run_context=None):
    ...
    for fix in fixtures:
        ...
        record = {
            ...
            "home_pitcher_cache_stale": bool(fix.get("home_pitcher_cache_stale", False)),
            ...
            "away_pitcher_cache_stale": bool(fix.get("away_pitcher_cache_stale", False)),
    ...
    if longslop:
        ...
        if pk not in existing_keys:
            new_pick = {
                ...
                **_pitcher_publication_fields(longslop),
                "pick": longslop["pick"],
