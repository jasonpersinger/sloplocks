...
class NhlMatchupModel:
    ...
    def _aggregate(self, logs):
        ...
        return {
            ...
            "shots_against": _avg("shots_against"),
            "blocked_shots": _avg("blocked_shots"),
    ...
    def _feature_vector(self, home_logs, away_logs, home_goalie_logs=None, away_goalie_logs=None, game_date=None):
        ...
        return np.array([
            ...
            away_recent["shots_against"] - home_recent["shots_against"],
            home_recent["blocked_shots"] - away_recent["blocked_shots"],
            ...
            home_recent["penalty_kill_pct"] - away_recent["penalty_kill_pct"],
