...
SPORTS = {
    ...
    "epl": {
        ...
        "models": ["elo"],
        "accuracy_softmax_temperature": 2.5,
        "probability_calibration_min_samples": 15,
        "probability_calibration_blend": 0.4,
        "probability_calibration_window_days": 365,
        "probability_calibration_holdout_days": 14,
        "elo_k_factor": 25,
        ...
        "slop_lock_confidence_threshold": 45,
    ...
    "mls": {
        ...
        "probability_calibration_holdout_days": 7,
        "elo_k_factor": 20,
        "elo_home_advantage": 45, # MLS has high home advantage
        "min_expected_value": 0.0,
        "kelly_fraction": 0.15,
        "slop_lock_edge_threshold": 0.02,
        "slop_lock_probability_floor": 0.30,
        ...
        "qualitative_weight": 0.4,
        "enable_qualitative": True,
        "data_dir": os.path.join(DATA_DIR, "mls"),
    },
}
